...
//     clients.data = filterData(clients.data, ProjectID, 'ProjectID');
//     clients.data = filterData(clients.data, SprintID, 'SprintID');
//     clients.data = filterData(clients.data, ResourceID, 'ResourceID');
//     res.json(clients);
// });
...
//     projects.data = filterData(projects.data, ClientID, 'ClientID');
//     projects.data = filterData(projects.data, SprintID, 'SprintID');
//     projects.data = filterData(projects.data, ResourceID, 'ResourceID');
//     res.json(projects);
// });
...
//     sprints.data = filterData(sprints.data, ClientID, 'ClientID');
//     sprints.data = filterData(sprints.data, ProjectID, 'ClientID');
//     sprints.data = filterData(sprints.data, ResourceID, 'ResrouceID');
//     res.json(sprints);
// })
...
// app.post('/FilteredResource', (req, res) => {
//     const { ClientID, ProjectID, SprintID } = req.body;
//     let resources = readJsonFileSync(path.join(__dirname, '/Public/Resources.json'));
//     resources.data = filterData(resources.data, ClientID, 'ClientID');
//     resources.data = filterData(resources.data, ProjectID, 'ProjectID');
//     resources.data = filterData(resources.data, SprintID, 'SprintID');
//     res.json(resources);
// })
...
// app.post('/FilteredData', (req, res) => {
//     const { ClientID, ProjectID, SprintID, ResourceID } = req.body;
//     let stuff = readJsonFileSync(path.join(__dirname, '/Public/InitialData.json'));
//     stuff.data = filterData(stuff.data, ClientID, 'ClientID');
//     stuff.data = filterData(stuff.data, ProjectID, 'ProjectID');
//     stuff.data = filterData(stuff.data, SprintID, 'SprintID');
//     stuff.data = filterData(stuff.data, ResourceID, 'ResourceID');
//     res.json(stuff);
// })
